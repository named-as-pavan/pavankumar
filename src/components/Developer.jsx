...
*/
  ...
  const {actions } = useAnimations([idleAnimations[0],saluteAnimations[0],clappingAnimations[0],victoryAnimations[0]],groupRef)

  useEffect(() => {
    actions[animationsName].reset().fadeIn(0.5).play();

    return () => actions[animationsName].fadeOut(0.5)
  } ,[animationsName])
  return(
